    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="items-center hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul
                ...
                <li><a href="/"
                        class="block py-2 px-3 text-white bg-[#09637E] rounded md:bg-transparent md:text-[#09637E] md:p-0 md:font-semibold">Beranda</a>
                </li>
                <li><a href="#layanan"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#09637E] md:p-0">Layanan</a>
                </li>
                <li><a href="#tentang"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#09637E] md:p-0">Tentang
                        Kami</a></li>
            </ul>
        </div>
        ...
        <div class="flex md:order-2 space-x-3">
            <a href="{{ route('login') }}"
                class="hidden md:flex items-center px-5 py-2.5 text-sm font-medium text-[#09637E] border border-[#09637E] rounded-full hover:bg-[#09637E] hover:text-white transition-all duration-300">
                Login
            </a>
            <a href="{{ route('registrasi') }}"
                class="flex items-center px-5 py-2.5 text-sm font-medium text-white bg-[#09637E] rounded-full hover:bg-[#074d61] shadow-md transition-all duration-300">
                Registrasi
            </a>
        </div>
    </div>
