...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="bg-white rounded-2xl shadow-sm p-5">
            <div class="flex items-center justify-between">
                ...
                <div class="w-10 h-10 bg-[#09637E]/10 rounded-xl flex items-center justify-center">
                    <svg class="w-5 h-5 text-[#09637E]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm p-5">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-[11px] text-gray-400 mt-0.5">Rabu, Sabtu, Minggu</p>
                </div>
    ...
    <div class="relative w-full max-w-xs">
        ...
        <div class="relative" id="dropdownWrapper">
            <div class="flex items-center border border-gray-200 rounded-xl px-3 py-2 cursor-pointer hover:border-gray-300 transition" onclick="toggleDropdown()">
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="bg-gray-50 text-gray-500 text-xs uppercase tracking-wide">
                    <th class="px-5 py-3.5 text-left font-semibold rounded-tl-2xl">Hari</th>
                    <th class="px-5 py-3.5 text-left font-semibold">Jam</th>
                    <th class="px-5 py-3.5 text-center font-semibold">Kapasitas</th>
                    <th class="px-5 py-3.5 text-center font-semibold">Terisi</th>
                    <th class="px-5 py-3.5 text-center font-semibold">Status</th>
                    <th class="px-5 py-3.5 text-right font-semibold rounded-tr-2xl">Aksi</th>
                </tr>
            </thead>
            <tbody id="tbodyJadwal" class="text-gray-700">
                <tr class="border-b border-gray-50 hover:bg-gray-50/60 transition jadwal-row" data-hari="senin">
                    ...
                    <td class="px-5 py-4 text-center">
                        <span class="inline-flex items-center justify-center w-10 h-7 rounded-lg bg-gray-50 text-xs font-semibold">20</span>
                    </td>
                    <td class="px-5 py-4 text-center">
                        <span class="inline-flex items-center justify-center w-10 h-7 rounded-lg bg-[#09637E]/10 text-[#09637E] text-xs font-semibold">12</span>
                    </td>
                    <td class="px-5 py-4 text-center">
                        <span class="px-3 py-1 text-xs rounded-full bg-green-50 text-green-600 font-medium border border-green-100">Aktif</span>
                    </td>
                    <td class="px-5 py-4 text-right">
                        <button onclick="openPasienModal(0)" class="bg-[#09637E] hover:bg-[#074f63] text-white px-4 py-2 rounded-lg text-xs font-semibold transition inline-flex items-center gap-1.5">
                ...
                <tr class="border-b border-gray-50 hover:bg-gray-50/60 transition jadwal-row" data-hari="selasa">
                    ...
                    <td class="px-5 py-4 text-center">
                        <span class="inline-flex items-center justify-center w-10 h-7 rounded-lg bg-gray-50 text-xs font-semibold">15</span>
                    </td>
                    <td class="px-5 py-4 text-center">
                        <span class="inline-flex items-center justify-center w-10 h-7 rounded-lg bg-[#09637E]/10 text-[#09637E] text-xs font-semibold">5</span>
                    </td>
                    <td class="px-5 py-4 text-center">
                        <span class="px-3 py-1 text-xs rounded-full bg-green-50 text-green-600 font-medium border border-green-100">Aktif</span>
                    </td>
                    <td class="px-5 py-4 text-right">
                        <button onclick="openPasienModal(1)" class="bg-[#09637E] hover:bg-[#074f63] text-white px-4 py-2 rounded-lg text-xs font-semibold transition inline-flex items-center gap-1.5">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                            Lihat Pasien
                        </button>
                    </td>
                ...
                <tr class="border-b border-gray-50 hover:bg-gray-50/60 transition jadwal-row" data-hari="rabu">
                    ...
                    <td class="px-5 py-4 text-center text-gray-300">-</td>
                    <td class="px-5 py-4 text-center">
                        <span class="px-3 py-1 text-xs rounded-full bg-red-50 text-red-400 font-medium border border-red-100">Cuti</span>
                    </td>
                ...
                <tr class="border-b border-gray-50 hover:bg-gray-50/60 transition jadwal-row" data-hari="kamis">
                    ...
                    <td class="px-5 py-4 text-center">
                        <span class="inline-flex items-center justify-center w-10 h-7 rounded-lg bg-gray-50 text-xs font-semibold">25</span>
                    </td>
                    <td class="px-5 py-4 text-center">
                        <span class="inline-flex items-center justify-center w-10 h-7 rounded-lg bg-[#09637E]/10 text-[#09637E] text-xs font-semibold">18</span>
                    </td>
                    <td class="px-5 py-4 text-center">
                        <span class="px-3 py-1 text-xs rounded-full bg-green-50 text-green-600 font-medium border border-green-100">Aktif</span>
                    </td>
                    <td class="px-5 py-4 text-right">
                        <button onclick="openPasienModal(2)" class="bg-[#09637E] hover:bg-[#074f63] text-white px-4 py-2 rounded-lg text-xs font-semibold transition inline-flex items-center gap-1.5">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                            Lihat Pasien
                        </button>
                    </td>
                ...
                <tr class="border-b border-gray-50 hover:bg-gray-50/60 transition jadwal-row" data-hari="jumat">
                    ...
                    <td class="px-5 py-4 text-center">
                        <span class="inline-flex items-center justify-center w-10 h-7 rounded-lg bg-[#09637E]/10 text-[#09637E] text-xs font-semibold">20</span>
                    </td>
                    <td class="px-5 py-4 text-center">
                        <span class="px-3 py-1 text-xs rounded-full bg-blue-50 text-blue-600 font-medium border border-blue-100">Penuh</span>
                    </td>
                    <td class="px-5 py-4 text-right">
                        <button onclick="openPasienModal(3)" class="bg-[#09637E] hover:bg-[#074f63] text-white px-4 py-2 rounded-lg text-xs font-semibold transition inline-flex items-center gap-1.5">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                            Lihat Pasien
                        </button>
                    </td>
            ...
            <div class="px-6 pt-6 pb-4 border-b border-gray-100">
                <div class="flex items-start justify-between">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1">Poliklinik Umum &bull; Dr. Sarah Wijaya</p>
                        <p class="text-xs text-gray-400 mt-0.5">20 November 2025</p>
                    </div>
                    <button onclick="closePasienModal()" class="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-gray-100 text-gray-400 hover:text-gray-600 transition -mr-1 -mt-1">
            ...
            <div class="flex-1 overflow-auto">
                <table class="w-full text-sm">
                    <thead class="sticky top-0 z-10">
                        <tr class="bg-gray-50 text-gray-500 text-xs uppercase tracking-wide">
                            <th class="px-6 py-3 text-left font-semibold w-12">No</th>
                            <th class="px-6 py-3 text-left font-semibold">Nama Pasien</th>
                            <th class="px-6 py-3 text-left font-semibold">Keluhan</th>
                            <th class="px-6 py-3 text-center font-semibold w-24">Status</th>
                            <th class="px-6 py-3 text-center font-semibold w-24">Aksi</th>
                        </tr>
                    </thead>
...
function renderModalTable() {
    ...
    tbody.innerHTML = pageData.map((p, i) => {
        ...
        return `<tr class="border-b border-gray-50 hover:bg-gray-50/60 transition">
            <td class="px-6 py-3.5 text-gray-400 text-xs font-medium">${no}</td>
            <td class="px-6 py-3.5"><div class="flex items-center gap-2.5"><div class="w-8 h-8 rounded-full bg-[#09637E]/10 text-[#09637E] text-xs font-bold flex items-center justify-center flex-shrink-0">${initials}</div><span class="font-medium text-gray-800">${p.nama}</span></div></td>
            <td class="px-6 py-3.5 text-gray-500">${p.keluhan}</td>
            <td class="px-6 py-3.5 text-center"><span class="px-2.5 py-1 text-xs rounded-full bg-amber-50 text-amber-600 font-medium border border-amber-100">${p.status}</span></td>
            <td class="px-6 py-3.5 text-center"><button class="px-3 py-1.5 text-xs rounded-lg bg-[#09637E] hover:bg-[#074f63] text-white font-semibold transition">Periksa</button></td>
        </tr>`;
    }).join('');
}
