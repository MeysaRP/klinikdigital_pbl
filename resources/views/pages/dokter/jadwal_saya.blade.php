            ...
            <table class="w-full text-sm min-w-[500px]">
                <thead>
                    <tr class="bg-gray-50 text-gray-500 text-xs uppercase tracking-wide font-semibold">
                        ...
                        <th class="px-5 py-3.5 text-center rounded-tr-2xl">Status</th>
                    </tr>
                </thead>
                <tbody id="tbodyJadwal" class="text-gray-700">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-5 py-8 text-center text-sm text-gray-400">Belum ada jadwal dokter. Silakan minta admin menambahkan jadwal.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
