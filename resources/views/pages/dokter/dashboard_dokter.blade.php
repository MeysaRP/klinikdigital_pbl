...
<div class="space-y-6">
    ...
    <div class="relative bg-gradient-to-br from-[#09637E] to-[#074f63] rounded-2xl p-6 text-white overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <h1 class="text-xl font-bold">Selamat datang, dr. Sarah Wijaya</h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div class="bg-white rounded-2xl shadow-sm p-5 border border-gray-100/80">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <div class="mt-3 flex items-center gap-2">
                        ...
                        <span class="text-[10px] text-gray-400">dari 10 total</span>
                    </div>
                </div>
                <div class="w-14 h-14 bg-amber-50 rounded-2xl flex items-center justify-center ml-4">
            ...
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-[10px] text-gray-400 mt-1">67% dari kuota hari ini</p>
                    </div>
                </div>
                <div class="w-14 h-14 bg-green-50 rounded-2xl flex items-center justify-center ml-4">
            ...
            <div class="flex flex-col sm:flex-row gap-5">
                ...
                <div class="flex-1 space-y-3.5">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-[11px] text-gray-400 uppercase tracking-wide font-medium">No. antrian</p>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-[11px] text-gray-400 uppercase tracking-wide font-medium">Nama</p>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-[11px] text-gray-400 uppercase tracking-wide font-medium">Keluhan</p>
                ...
                <div class="flex sm:flex-col items-center sm:items-end justify-center sm:justify-center sm:pt-2">
                    <button class="w-full sm:w-auto bg-[#09637E] hover:bg-[#074f63] text-white px-6 py-3 rounded-xl text-sm font-semibold transition inline-flex items-center justify-center gap-2 shadow-md hover:shadow-lg">
