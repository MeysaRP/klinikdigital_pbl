                        ...
                        @foreach ($pasien as $p)
                            <tr class="pasien-row hover:bg-gray-50 transition" data-id="{{ $p->id }}"
                                ...
                                <td class="px-5 py-3.5 text-right">
                                    <button data-id="{{ $p->id }}" data-nama="{{ $p->name }}"
                                        data-tgl="{{ $p->tgl_lahir }}" data-jk="{{ $p->jk }}"
                                        data-no_hp="{{ $p->no_hp }}" data-alamat="{{ $p->alamat }}"
            ...
            <div class="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-y-auto max-h-[calc(100vh-4rem)]">
                ...
                <div class="p-6 pt-0 space-y-4">
                    <div>
                        ...
                        <input id="edit_nama"
                            class="w-full border border-gray-200 bg-gray-50 rounded-xl px-4 py-2.5 outline-none focus:ring-2 focus:ring-[#09637E]/20 focus:border-[#09637E] transition">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-600 mb-1">Tanggal Lahir</label>
                        <input id="edit_tgl" type="date"
                            class="w-full border border-gray-200 bg-gray-50 rounded-xl px-4 py-2.5 outline-none focus:ring-2 focus:ring-[#09637E]/20 focus:border-[#09637E] transition">
                    </div>
                    ...
                    <div>
                        ...
                        <select id="edit_jk"
                            class="w-full border border-gray-200 bg-gray-50 rounded-xl px-4 py-2.5 outline-none focus:ring-2 focus:ring-[#09637E]/20 focus:border-[#09637E] transition appearance-none">
