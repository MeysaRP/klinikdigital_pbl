            ...
            <div class="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                ...
                <div class="text-gray-700">
                    ...
                    <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                        <a href="#layanan" class="inline-flex items-center justify-center gap-2 py-3 px-6 text-base font-semibold text-white rounded-full bg-[#09637E] hover:bg-[#074d61] shadow-[0_10px_25px_-5px_rgba(9,99,126,0.4)] hover:shadow-[0_20px_35px_-5px_rgba(9,99,126,0.5)] transition-all duration-300 transform hover:-translate-y-0.5">
                            Lihat Layanan
        ...
        <div class="max-w-screen-xl mx-auto px-4 text-center relative z-10">
            ...
            <div class="grid gap-10 md:grid-cols-3 px-4">
                ...
                <div class="group flex flex-col items-center bg-white border border-gray-100 rounded-3xl p-8 md:p-10 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.1)] hover:shadow-[0_20px_40px_-10px_rgba(9,99,126,0.3)] transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
                    ...
                    <p class="text-gray-500 text-center leading-relaxed">Daftar antrean dan pilih jadwal dokter dengan mudah tanpa mengantri.</p>
                </div>
                ...
                <div class="group flex flex-col items-center bg-white border border-gray-100 rounded-3xl p-8 md:p-10 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.1)] hover:shadow-[0_20px_40px_-10px_rgba(9,99,126,0.3)] transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
                    ...
                    <p class="text-gray-500 text-center leading-relaxed">Tenaga medis bersertifikat dan berpengalaman di bidangnya.</p>
                </div>
                ...
                <div class="group flex flex-col items-center bg-white border border-gray-100 rounded-3xl p-8 md:p-10 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.1)] hover:shadow-[0_20px_40px_-10px_rgba(9,99,126,0.3)] transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
                    ...
                    <p class="text-gray-500 text-center leading-relaxed">Riwayat kesehatan tersimpan rapi, mudah diakses kapan saja.</p>
                </div>
            </div>
        </div>
    </section>
